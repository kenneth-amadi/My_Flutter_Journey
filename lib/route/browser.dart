...
class Browser extends StatefulWidget {
  ...
  const Browser({Key? key, required this.url, this.cookieManager}) : super(key: key);
...
class SampleMenu extends StatelessWidget {
  ...
  Future<void> _onAddToCache(WebViewController controller, BuildContext context) async {
    await controller.runJavascript('caches.open("test_caches_entry"); localStorage["test_localStorage"] = "dummy_entry";');
